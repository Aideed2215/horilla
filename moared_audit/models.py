...
class moaredAuditInfo(models.Model):
    """
    moaredAuditInfo model to store additional info
    """
...
def post_create_moared_audit_log(sender, instance, *_args, **kwargs):
    ...
    try:
        ...
        if isinstance(history_instance, moaredAuditLog):
