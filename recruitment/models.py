...
class SurveyTemplate(moaredModel):
    """
    ...
    objects = moaredCompanyManager("company_id")

    def __str__(self) -> str:
        return self.title


class Skill(moaredModel):
...
class Stage(moaredModel):
    ...
    objects = moaredCompanyManager(related_company_field="recruitment_id__company_id")
...
class RejectReason(moaredModel):
    """
    RejectReason
    """
...
class RejectedCandidate(moaredModel):
    """
    RejectedCandidate
    """
...
class RecruitmentSurvey(moaredModel):
    """
    ...
    objects = moaredCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(moaredModel):
    """
...
class RecruitmentSurveyAnswer(moaredModel):
    """
...
class RecruitmentMailTemplate(moaredModel):
...
class SkillZoneCandidate(moaredModel):
    """
...
class CandidateRating(moaredModel):
...
class RecruitmentGeneralSetting(moaredModel):
    """
...
class InterviewSchedule(moaredModel):
    """
    ...
    objects = moaredCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateDocumentRequest(moaredModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(moaredModel):
