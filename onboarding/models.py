...
class OnboardingStage(moaredModel):
    """
    ...
    objects = moaredCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(moaredModel):
    """
    ...
    objects = moaredCompanyManager("stage_id__recruitment_id__company_id")

    def __str__(self):
        return f"{self.task_title}"


class CandidateStage(moaredModel):
    """
...
class CandidateTask(moaredModel):
    """
    CandidateTask model
    """
...
class OnboardingPortal(moaredModel):
    """
