...
class AssetCategory(moaredModel):
    """
...
class Asset(moaredModel):
    ...
    objects = moaredCompanyManager("asset_category_id__company_id")
...
class AssetDocuments(moaredModel):
    """
...
class ReturnImages(moaredModel):
    """
...
class AssetAssignment(moaredModel):
    """
    ...
    objects = moaredCompanyManager("asset_id__asset_lot_number_id__company_id")
...
class AssetRequest(moaredModel):
    """
